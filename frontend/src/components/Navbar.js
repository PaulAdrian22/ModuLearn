    ...
    <>
      <nav className="bg-white border-b border-gray-100 shadow-sm sticky top-0 z-50">
        ...
        <div className="flex items-center space-x-5">
          ...
          <button onClick={handleLogout} className="flex items-center text-gray-400 hover:text-red-500 transition-colors duration-200 p-3 rounded-lg hover:bg-red-50" title="Logout">
            <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {isGuideOpen && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/40 p-4" onClick={() => setIsGuideOpen(false)}>
          <div
          ...
          >
            <div className="flex items-start justify-between border-b border-gray-100 px-6 py-4">
              <div>
                <h2 className="text-xl font-bold text-[#1e3a5f]">System Guide</h2>
                <p className="mt-1 text-sm text-gray-500">Quick help for using the ModuLearn system</p>
              </div>
              <button
            ...
            <div className="space-y-4 px-6 py-5">
              <div className="rounded-xl border border-dashed border-[#2BC4B3]/60 bg-[#f0faf9] px-4 py-3 text-sm text-[#1e3a5f]">
                Guide content placeholder. You can add your full system guide here later.
              </div>
              <ul className="list-disc space-y-2 pl-5 text-sm text-gray-600">
                <li>Overview of dashboard and lessons</li>
                <li>How to view progress and mastery</li>
                <li>How to start and submit simulations</li>
                <li>Where to update account/profile settings</li>
              </ul>
            </div>
          </div>
        </div>
