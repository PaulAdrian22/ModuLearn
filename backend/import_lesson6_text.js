...
const LESSON_DOCX_PATH = path.join(__dirname, '..', 'lessons', 'Lessons_6.docx');
const ASSESSMENT_DOCX_PATH = path.join(__dirname, '..', 'lessons', 'Assesssments_lesson_6.docx');
...
const main = async () => {
  try {
    ...
    const snapshotPath = path.join(__dirname, '..', 'lessons', 'lesson6_after_import_snapshot.json');
