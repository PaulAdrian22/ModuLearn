...
process.env.LESSON_DOCX_PATH = path.join(__dirname, '..', 'lessons', 'Lessons_1.docx');
process.env.ASSESSMENT_DOCX_PATH = path.join(__dirname, '..', 'lessons', 'Assessments_lesson_1.docx');
