...
process.env.LESSON_DOCX_PATH = path.join(BACKEND_DIR, '..', 'lessons', 'Lessons_3.docx');
process.env.ASSESSMENT_DOCX_PATH = path.join(BACKEND_DIR, '..', 'lessons', 'Assessments_lesson_3.docx');
