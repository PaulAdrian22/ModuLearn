...
const LESSON_DOCX_PATH = path.join(BACKEND_DIR, '..', 'lessons', 'Lessons_7.docx');
const ASSESSMENT_DOCX_PATH = path.join(BACKEND_DIR, '..', 'lessons', 'Assessments_lesson_7.docx');
...
const main = async () => {
  try {
    ...
    const snapshotPath = path.join(BACKEND_DIR, '..', 'lessons', 'lesson7_after_import_snapshot.json');
