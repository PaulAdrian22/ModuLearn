...
const SIMULATION_ROOT = path.resolve(BACKEND_DIR, '..', 'Simulations', 'simulation webp');
const DOCX_INSTRUCTIONS_PATH = path.resolve(BACKEND_DIR, '..', 'Simulations', 'Assessments_ModuLearn.docx');
const UPLOAD_ROOT = path.resolve(BACKEND_DIR, 'uploads', 'simulations');
